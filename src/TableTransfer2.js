...
function TableTransfer2() {
    ...
    const handleClick =(e)=>{
        ...
        if(CurrentBalance>=userEnteredAmount){
            ...
            alert(`Rs. ${userEnteredAmount} Transferred from AccountNumber-100102 to AccountNumber-${userEnteredAccountNo} `)
    
            let D=`Rs. ${userEnteredAmount} Transferred from AccountNumber-100102 to AccountNumber-${userEnteredAccountNo} `;  
