        ...
        if(userEnteredAccountNo==100101 || userEnteredAccountNo==100102 || 
            ...
            userEnteredAccountNo==100107){
                ...
                if(CurrentBalance>=userEnteredAmount){
                    ...
                    alert(`Rs. ${userEnteredAmount} Transferred from AccountNumber-100106 to AccountNumber-${userEnteredAccountNo} `)
            
                    let D=`Rs. ${userEnteredAmount} Transferred from AccountNumber-100106 to AccountNumber-${userEnteredAccountNo} `;  
