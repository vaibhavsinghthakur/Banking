...
function TableTransfer7() {
    ...
    const handleClick =(e)=>{
        ...
        if(CurrentBalance>=userEnteredAmount){
            ...
            alert(`Rs. ${userEnteredAmount} Transferred from AccountNumber-100107 to AccountNumber-${userEnteredAccountNo} `)
    
            let D=`Rs. ${userEnteredAmount} Transferred from AccountNumber-100107 to AccountNumber-${userEnteredAccountNo} `;  
