...
function TableTransfer4() {
    ...
    const handleClick =(e)=>{
        ...
        if(CurrentBalance>=userEnteredAmount){
            ...
            alert(`Rs. ${userEnteredAmount} Transferred from AccountNumber-100104 to AccountNumber-${userEnteredAccountNo} `)
    
            let D=`Rs. ${userEnteredAmount} Transferred from AccountNumber-100104 to AccountNumber-${userEnteredAccountNo} `;  
