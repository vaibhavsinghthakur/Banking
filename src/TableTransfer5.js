...
function TableTransfer5() {
    ...
    const handleClick =(e)=>{
        ...
        alert(`Rs. ${userEnteredAmount} Transferred from AccountNumber-100105 to AccountNumber-${userEnteredAccountNo} `)

        let D=`Rs. ${userEnteredAmount} Transferred from AccountNumber-100105 to AccountNumber-${userEnteredAccountNo} `;  
